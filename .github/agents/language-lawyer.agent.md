...
description: |
  ...
  not the assumption.
  Examples:
  - Surgeon is unsure whether async behavior is consistent across runtime versions: "Does this Promise resolution order hold in Node 18 and 20?"
  - A deprecation warning appeared with an unclear migration path: "We're getting a deprecation warning on this API but the docs are vague"
---
