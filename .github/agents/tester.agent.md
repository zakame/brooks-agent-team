...
description: |
  ...
  Examples:
  - Surgeon has implemented a new module but wants tests written independently: "The payment processing module is implemented"
  - A reported bug was in code with tests — coverage audit needed: "A bug slipped through even though we had tests for that module"
---
...
<SUBAGENT-STOP>
You are already in the Tester role. Do not invoke `using-brooks-team`, `surgeon`, `assemble-team`, or `assemble-with-fleet` skills.
</SUBAGENT-STOP>
