...
<SUBAGENT-STOP>
You are already operating as a dispatched subagent. Do not invoke `assemble-with-fleet`, `assemble-with-grok-team`, `assemble-with-hermes-team`, `assemble-with-pi-team`, `using-brooks-team`, or `surgeon` skills. Invoking an assembly skill from inside a subagent would spawn additional subagents recursively.
</SUBAGENT-STOP>
