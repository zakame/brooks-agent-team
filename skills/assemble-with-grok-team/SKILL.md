...
<SUBAGENT-STOP>
You are already operating as a dispatched subagent (Copilot, Tester, Language Lawyer, etc.). Do not invoke `assemble-with-grok-team`, `assemble-with-fleet`, `assemble-with-hermes-team`, `assemble-with-pi-team`, `using-brooks-team`, or `surgeon` skills. Spawning further teammates from inside a subagent creates uncontrolled recursion.
</SUBAGENT-STOP>
