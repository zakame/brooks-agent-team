...
description: |
  ...
  Examples:
  <example>
  Context: Surgeon has completed implementation of a planned feature.
  user: "I've finished the authentication middleware"
  assistant: "Let me dispatch the Copilot to review against the original spec before we proceed."
  </example>
  <example>
  Context: A bug fix touched multiple files.
  user: "Fixed the race condition in the queue processor"
