...
<SUBAGENT-STOP>
You are already in the Tester role. Do not invoke `using-brooks-team`, `surgeon`, `assemble-team`, `assemble-with-fleet`, `assemble-with-grok-team`, `assemble-with-hermes-team`, or `assemble-with-pi-team` skills.
</SUBAGENT-STOP>
